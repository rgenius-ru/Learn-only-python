...
set_groups = {'ЁП', 'Чёткие приколы', 'Четкие Приколы', 'Корпорация зла',
...
group_masha = ['Корпорация зла', 'Палата №6', 'Лайфхак']


common_groups = ['Корпорация зла']  # пересечение
union_groups = ['ЁП', 'Чёткие приколы', 'Четкие Приколы', 'Корпорация зла',
                'Палата №6', 'Лайфхак', 'Психология отношений']  # объединение
symmetrical_difference = ['ЁП', 'Чёткие приколы', 'Четкие Приколы',
                          'Палата №6', 'Лайфхак', 'Психология отношений']  # симметричная разница
difference_lisa_kira = ['ЁП']  # группы киры минус группы лизы
difference_kira_lisa = []  # группы лизы минус группы киры
